...
class RoblesApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: EsScaffold(title: 'Flutter en Español Robles'),
    ); // fin de material
  } // fin de widget
} // fin de RoblesApp
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Text('bottomNavigationBar con BottomAppBar por Robles')
            ],
          ),
        ),
      ),
